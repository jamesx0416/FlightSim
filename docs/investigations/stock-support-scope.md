...
- 2026-05-28: The public `Asobo/Misc/*` family remains unchecked because the active aircraft routes do not instantiate those standalone avionics/instrument units or non-aircraft ground-service/SimObject templates. Shared generic input and timed-button primitives are covered elsewhere, but AS Digiflo, FP5L, AS Propeller, Vigilus, EPM, Accelerometer, GX2, Pl463, Volts/Amps, ground vehicle, and jetway/wind SimObject contracts need representative fixtures or harnesses.
- 2026-05-28: `Asobo/Generic/Complex/*` and the animation/update subtemplates are broadly but partially covered by the existing generic interaction, animation, update, sound-trigger, emissive, and blocker work. They remain unchecked as full files because many branch matrices, especially joystick, knob, switch, covered-button, recursive animation-event, and recursive multistate-update variants, have not all been mounted-stock exercised.
